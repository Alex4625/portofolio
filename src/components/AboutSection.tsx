      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          {data.stats && data.stats.map((stat: any, index: number) => (
            <div
              key={index}
              className="bg-card rounded-none p-6 md:p-8 shadow-sm border border-border hover:shadow-md transition-shadow duration-300 flex flex-col justify-center"
            >
          ...
          <div className="bg-accent/5 rounded-none p-6 md:p-8 shadow-sm border border-accent/10 hover:shadow-md transition-shadow duration-300 flex items-center justify-center">
